import { Component, OnInit, CanDeactivate } from 'angular2/core';
import { FormBuilder, ControlGroup, ControlArray, Control, Validators } from 'angular2/common';
...
export class RecipeEditComponent implements OnInit, CanDeactivate {
	...
	routerCanDeactivate(nextInstruction: ComponentInstruction, prevInstruction: ComponentInstruction) {
		if (this._submitted === true || this.myForm.pristine) {
			return true;
		}
